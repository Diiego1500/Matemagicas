...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-03-2019 a las 13:06:14
...
CREATE TABLE `blog_article` (
  ...
  `image_author` varchar(255) COLLATE utf8_unicode_ci NOT NULL
...
--
-- Estructura de tabla para la tabla `blog_notification`
--

CREATE TABLE `blog_notification` (
  `id` int(11) NOT NULL,
  `email` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `blog_recibido` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `activate` tinyint(1) NOT NULL,
  `secret_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `blog_notification`
--

INSERT INTO `blog_notification` (`id`, `email`, `blog_recibido`, `activate`, `secret_token`) VALUES
(5, 'diegofernando150_@hotmail.es', '[1,1,2]', 1, '153959a5cf6cbd136e9ae2fe9096fd37'),
(6, 'diego.fernando.bastidas@correounivalle.edu.co', '[1,1,2]', 1, '37b2ec492ec37662653a692544dfd21f');
...
(46, 4, 2, 'primary/sum/sum44.png', '2571', '2571', 5, 0, 0),
...
(172, 6, 2, 'primary/mul/mul38.png', '3420', '3420', 174, 0, 0),
...
(276, 8, 2, 'primary/simb/simb22.png', '0', 'V', 291, 1, 0),
...
(291, 8, 2, 'primary/simb/simb34.png\r\n', '0', 'F', 1000, 1, 0),
...
(352, 9, 2, 'primary/frac/fr32.png', '0', '68slash45', 360, 0, 0),
...
(385, 10, 2, 'primary/poten/pot16.png', '3125', '3125', 393, 0, 0),
...
(10, 1, 'Potenciación', '[\"https://www.youtube.com/embed/bnwBXIcIi2k\",\"pot1.jpg\"]', 'Imagina que una bacteria se divide en dos. Luego esas dos bacterias se dividen cada una en otras 2, luego estas cuatro bacterias se dividen cada una en dos. ¿Cómo se calcula la cantidad de bacterias que habrá en un determinado momento? Para este proceso utilizaremos la potenciación.', 393),
(11, 1, 'Radicación', '[\"https://www.youtube.com/embed/vAH_w49KhUg\"]', 'En ocasiones, necesitamos conocer en la base de una potencia, ¿Lo notas? La radicación es el proceso contrario a la potenciación. A continuación, te presentamos una sección de ejercicios para que practiques esta técnica matemática que te será muy útil en el futuro.', 412),
(12, 1, 'Orden de evaluación o Leyes de precedencia', '[\"https://www.youtube.com/embed/preiNtvbvFk\",\"https://www.youtube.com/embed/SzyQ9EDspOE\"]', '¿Y si nos encontramos con un proceso que tiene muchas sumas, restas, multiplicaciones y divisiones? ¿Cómo podemos resolver todo este problema? ¿Por dónde empiezo? Bueno, afortunadamente existen las leyes de precedencia o también conocidas como orden de evaluación, En esta sección aprenderás la manera correcta de solucionar dichos problemas', 433),
...
--
-- Indices de la tabla `blog_notification`
--
...
--
-- AUTO_INCREMENT de la tabla `blog_notification`
--
ALTER TABLE `blog_notification`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
